...
(async () => {
  ...
  for (const zip of zips) {
    ...
    /* eslint-disable */
      const dataPerZip = `
## ${constants.city}, ${constants.zip}, ${constants.state} - ${date} ![${city}, ${zip}, ${state} :](https://github.com/xgirma/moveto/workflows/${city},%20${zip},%20${state}%20:/badge.svg)

![${city}, ${zip}, ${state} houses](https://github.com/xgirma/moveto/blob/master/data/${zip}/chart.svg)
